...
void XKrnl_helm_Set_durations(XKrnl_helm *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XKrnl_helm_WriteReg(InstancePtr->Control_BaseAddress, XKRNL_HELM_CONTROL_ADDR_DURATIONS_DATA, Data);
}

u32 XKrnl_helm_Get_durations(XKrnl_helm *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XKrnl_helm_ReadReg(InstancePtr->Control_BaseAddress, XKRNL_HELM_CONTROL_ADDR_DURATIONS_DATA);
    return Data;
}

void XKrnl_helm_Set_route(XKrnl_helm *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XKrnl_helm_WriteReg(InstancePtr->Control_BaseAddress, XKRNL_HELM_CONTROL_ADDR_ROUTE_DATA, Data);
}

u32 XKrnl_helm_Get_route(XKrnl_helm *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XKrnl_helm_ReadReg(InstancePtr->Control_BaseAddress, XKRNL_HELM_CONTROL_ADDR_ROUTE_DATA);
    return Data;
}

void XKrnl_helm_Set_position(XKrnl_helm *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XKrnl_helm_WriteReg(InstancePtr->Control_BaseAddress, XKRNL_HELM_CONTROL_ADDR_POSITION_DATA, Data);
}

u32 XKrnl_helm_Get_position(XKrnl_helm *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XKrnl_helm_ReadReg(InstancePtr->Control_BaseAddress, XKRNL_HELM_CONTROL_ADDR_POSITION_DATA);
    return Data;
}

void XKrnl_helm_Set_departure(XKrnl_helm *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XKrnl_helm_WriteReg(InstancePtr->Control_BaseAddress, XKRNL_HELM_CONTROL_ADDR_DEPARTURE_DATA, Data);
}

u32 XKrnl_helm_Get_departure(XKrnl_helm *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XKrnl_helm_ReadReg(InstancePtr->Control_BaseAddress, XKRNL_HELM_CONTROL_ADDR_DEPARTURE_DATA);
    return Data;
}

void XKrnl_helm_Set_seed(XKrnl_helm *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XKrnl_helm_WriteReg(InstancePtr->Control_BaseAddress, XKRNL_HELM_CONTROL_ADDR_SEED_DATA, Data);
}

u32 XKrnl_helm_Get_seed(XKrnl_helm *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XKrnl_helm_ReadReg(InstancePtr->Control_BaseAddress, XKRNL_HELM_CONTROL_ADDR_SEED_DATA);
    return Data;
}

void XKrnl_helm_Set_base_r(XKrnl_helm *InstancePtr, u64 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XKrnl_helm_WriteReg(InstancePtr->Control_BaseAddress, XKRNL_HELM_CONTROL_ADDR_BASE_R_DATA, (u32)(Data));
    XKrnl_helm_WriteReg(InstancePtr->Control_BaseAddress, XKRNL_HELM_CONTROL_ADDR_BASE_R_DATA + 4, (u32)(Data >> 32));
}

u64 XKrnl_helm_Get_base_r(XKrnl_helm *InstancePtr) {
    u64 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XKrnl_helm_ReadReg(InstancePtr->Control_BaseAddress, XKRNL_HELM_CONTROL_ADDR_BASE_R_DATA);
    Data += (u64)XKrnl_helm_ReadReg(InstancePtr->Control_BaseAddress, XKRNL_HELM_CONTROL_ADDR_BASE_R_DATA + 4) << 32;
    return Data;
}
