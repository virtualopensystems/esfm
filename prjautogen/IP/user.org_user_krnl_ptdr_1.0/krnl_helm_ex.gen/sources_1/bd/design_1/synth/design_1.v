...
//Date        : Wed Jul  5 09:25:11 2023
//Host        : localhost running 64-bit CentOS Linux release 7.9.2009 (Core)
...
(* CORE_GENERATION_INFO = "design_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=7,numReposBlks=3,numNonXlnxBlks=0,numHierBlks=4,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=1,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=USER,da_clkrst_cnt=1,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "design_1.hwdef" *) 
module design_1
   (ap_clk,
    ap_rst_n,
    interrupt,
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.AP_CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.AP_CLK, ASSOCIATED_BUSIF s_axi_control:m_axi_gmem0, ASSOCIATED_RESET ap_rst_n, CLK_DOMAIN design_1_ap_clk_0, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input ap_clk;
  (* X_INTERFACE_INFO = "xilinx.com:signal:reset:1.0 RST.AP_RST_N RST" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME RST.AP_RST_N, INSERT_VIP 0, POLARITY ACTIVE_LOW" *) input ap_rst_n;
  (* X_INTERFACE_INFO = "xilinx.com:signal:interrupt:1.0 INTR.INTERRUPT INTERRUPT" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME INTR.INTERRUPT, PortWidth 1, SENSITIVITY LEVEL_HIGH" *) output interrupt;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 m_axi_gmem0 ARADDR" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME m_axi_gmem0, ADDR_WIDTH 64, ARUSER_WIDTH 1, AWUSER_WIDTH 1, BUSER_WIDTH 1, CLK_DOMAIN design_1_ap_clk_0, DATA_WIDTH 64, FREQ_HZ 100000000, HAS_BRESP 1, HAS_BURST 0, HAS_CACHE 1, HAS_LOCK 1, HAS_PROT 1, HAS_QOS 1, HAS_REGION 1, HAS_RRESP 1, HAS_WSTRB 1, ID_WIDTH 2, INSERT_VIP 0, MAX_BURST_LENGTH 256, NUM_READ_OUTSTANDING 16, NUM_READ_THREADS 1, NUM_WRITE_OUTSTANDING 16, NUM_WRITE_THREADS 1, PHASE 0.0, PROTOCOL AXI4, READ_WRITE_MODE READ_WRITE, RUSER_BITS_PER_BYTE 0, RUSER_WIDTH 1, SUPPORTS_NARROW_BURST 1, WUSER_BITS_PER_BYTE 0, WUSER_WIDTH 1" *) output [63:0]m_axi_gmem0_araddr;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 m_axi_gmem0 ARID" *) output [1:0]m_axi_gmem0_arid;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 m_axi_gmem0 ARLEN" *) output [7:0]m_axi_gmem0_arlen;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 m_axi_gmem0 ARLOCK" *) output [0:0]m_axi_gmem0_arlock;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 m_axi_gmem0 ARREADY" *) input [0:0]m_axi_gmem0_arready;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 m_axi_gmem0 ARVALID" *) output [0:0]m_axi_gmem0_arvalid;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 m_axi_gmem0 AWID" *) output [1:0]m_axi_gmem0_awid;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 m_axi_gmem0 AWLEN" *) output [7:0]m_axi_gmem0_awlen;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 m_axi_gmem0 AWLOCK" *) output [0:0]m_axi_gmem0_awlock;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 m_axi_gmem0 AWREADY" *) input [0:0]m_axi_gmem0_awready;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 m_axi_gmem0 AWVALID" *) output [0:0]m_axi_gmem0_awvalid;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 m_axi_gmem0 BID" *) input [1:0]m_axi_gmem0_bid;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 m_axi_gmem0 BREADY" *) output [0:0]m_axi_gmem0_bready;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 m_axi_gmem0 BVALID" *) input [0:0]m_axi_gmem0_bvalid;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 m_axi_gmem0 RDATA" *) input [63:0]m_axi_gmem0_rdata;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 m_axi_gmem0 RID" *) input [1:0]m_axi_gmem0_rid;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 m_axi_gmem0 RLAST" *) input [0:0]m_axi_gmem0_rlast;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 m_axi_gmem0 RREADY" *) output [0:0]m_axi_gmem0_rready;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 m_axi_gmem0 RVALID" *) input [0:0]m_axi_gmem0_rvalid;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 m_axi_gmem0 WDATA" *) output [63:0]m_axi_gmem0_wdata;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 m_axi_gmem0 WLAST" *) output [0:0]m_axi_gmem0_wlast;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 m_axi_gmem0 WREADY" *) input [0:0]m_axi_gmem0_wready;
  ...
  wire kernel_compute_profi_0_done_port;
  wire [63:0]kernel_compute_profi_0_m_axi_common_ARADDR;
  wire [1:0]kernel_compute_profi_0_m_axi_common_ARBURST;
  wire [3:0]kernel_compute_profi_0_m_axi_common_ARCACHE;
  wire [0:0]kernel_compute_profi_0_m_axi_common_ARID;
  wire [7:0]kernel_compute_profi_0_m_axi_common_ARLEN;
  wire [0:0]kernel_compute_profi_0_m_axi_common_ARLOCK;
  wire [2:0]kernel_compute_profi_0_m_axi_common_ARPROT;
  wire [3:0]kernel_compute_profi_0_m_axi_common_ARQOS;
  wire [0:0]kernel_compute_profi_0_m_axi_common_ARREADY;
  wire [2:0]kernel_compute_profi_0_m_axi_common_ARSIZE;
  wire [0:0]kernel_compute_profi_0_m_axi_common_ARUSER;
  wire kernel_compute_profi_0_m_axi_common_ARVALID;
  wire [63:0]kernel_compute_profi_0_m_axi_common_AWADDR;
  wire [1:0]kernel_compute_profi_0_m_axi_common_AWBURST;
  wire [3:0]kernel_compute_profi_0_m_axi_common_AWCACHE;
  wire [0:0]kernel_compute_profi_0_m_axi_common_AWID;
  wire [7:0]kernel_compute_profi_0_m_axi_common_AWLEN;
  wire [0:0]kernel_compute_profi_0_m_axi_common_AWLOCK;
  wire [2:0]kernel_compute_profi_0_m_axi_common_AWPROT;
  wire [3:0]kernel_compute_profi_0_m_axi_common_AWQOS;
  wire [0:0]kernel_compute_profi_0_m_axi_common_AWREADY;
  wire [2:0]kernel_compute_profi_0_m_axi_common_AWSIZE;
  wire [0:0]kernel_compute_profi_0_m_axi_common_AWUSER;
  wire kernel_compute_profi_0_m_axi_common_AWVALID;
  wire [1:0]kernel_compute_profi_0_m_axi_common_BID;
  wire kernel_compute_profi_0_m_axi_common_BREADY;
  wire [1:0]kernel_compute_profi_0_m_axi_common_BRESP;
  wire [0:0]kernel_compute_profi_0_m_axi_common_BUSER;
  wire [0:0]kernel_compute_profi_0_m_axi_common_BVALID;
  wire [63:0]kernel_compute_profi_0_m_axi_common_RDATA;
  wire [1:0]kernel_compute_profi_0_m_axi_common_RID;
  wire [0:0]kernel_compute_profi_0_m_axi_common_RLAST;
  wire kernel_compute_profi_0_m_axi_common_RREADY;
  wire [1:0]kernel_compute_profi_0_m_axi_common_RRESP;
  wire [0:0]kernel_compute_profi_0_m_axi_common_RUSER;
  wire [0:0]kernel_compute_profi_0_m_axi_common_RVALID;
  wire [63:0]kernel_compute_profi_0_m_axi_common_WDATA;
  wire kernel_compute_profi_0_m_axi_common_WLAST;
  wire [0:0]kernel_compute_profi_0_m_axi_common_WREADY;
  wire [7:0]kernel_compute_profi_0_m_axi_common_WSTRB;
  wire [0:0]kernel_compute_profi_0_m_axi_common_WUSER;
  wire kernel_compute_profi_0_m_axi_common_WVALID;
  wire [31:0]krnl_helm_0_departure_kernel;
  wire [31:0]krnl_helm_0_durations_kernel;
  wire krnl_helm_0_durations_kernel_ap_vld;
  wire krnl_helm_0_interrupt;
  wire [63:0]krnl_helm_0_m_axi_gmem0_ARADDR;
  wire [1:0]krnl_helm_0_m_axi_gmem0_ARBURST;
  wire [3:0]krnl_helm_0_m_axi_gmem0_ARCACHE;
  wire [7:0]krnl_helm_0_m_axi_gmem0_ARLEN;
  wire [1:0]krnl_helm_0_m_axi_gmem0_ARLOCK;
  wire [2:0]krnl_helm_0_m_axi_gmem0_ARPROT;
  wire [3:0]krnl_helm_0_m_axi_gmem0_ARQOS;
  wire [0:0]krnl_helm_0_m_axi_gmem0_ARREADY;
  wire [2:0]krnl_helm_0_m_axi_gmem0_ARSIZE;
  wire krnl_helm_0_m_axi_gmem0_ARVALID;
  wire [63:0]krnl_helm_0_m_axi_gmem0_AWADDR;
  wire [1:0]krnl_helm_0_m_axi_gmem0_AWBURST;
  wire [3:0]krnl_helm_0_m_axi_gmem0_AWCACHE;
  wire [7:0]krnl_helm_0_m_axi_gmem0_AWLEN;
  wire [1:0]krnl_helm_0_m_axi_gmem0_AWLOCK;
  wire [2:0]krnl_helm_0_m_axi_gmem0_AWPROT;
  wire [3:0]krnl_helm_0_m_axi_gmem0_AWQOS;
  wire [0:0]krnl_helm_0_m_axi_gmem0_AWREADY;
  wire [2:0]krnl_helm_0_m_axi_gmem0_AWSIZE;
  wire krnl_helm_0_m_axi_gmem0_AWVALID;
  wire krnl_helm_0_m_axi_gmem0_BREADY;
  wire [1:0]krnl_helm_0_m_axi_gmem0_BRESP;
  wire [0:0]krnl_helm_0_m_axi_gmem0_BVALID;
  wire [63:0]krnl_helm_0_m_axi_gmem0_RDATA;
  wire [0:0]krnl_helm_0_m_axi_gmem0_RLAST;
  wire krnl_helm_0_m_axi_gmem0_RREADY;
  wire [1:0]krnl_helm_0_m_axi_gmem0_RRESP;
  wire [0:0]krnl_helm_0_m_axi_gmem0_RVALID;
  wire [63:0]krnl_helm_0_m_axi_gmem0_WDATA;
  wire krnl_helm_0_m_axi_gmem0_WLAST;
  wire [0:0]krnl_helm_0_m_axi_gmem0_WREADY;
  wire [7:0]krnl_helm_0_m_axi_gmem0_WSTRB;
  wire krnl_helm_0_m_axi_gmem0_WVALID;
  wire [31:0]krnl_helm_0_position_kernel;
  wire [31:0]krnl_helm_0_route_kernel;
  wire [31:0]krnl_helm_0_seed_kernel;
  ...
  assign axi_interconnect_0_M00_AXI_ARREADY = m_axi_gmem0_arready[0];
  assign axi_interconnect_0_M00_AXI_AWREADY = m_axi_gmem0_awready[0];
  assign axi_interconnect_0_M00_AXI_BID = m_axi_gmem0_bid[1:0];
  assign axi_interconnect_0_M00_AXI_BRESP = m_axi_gmem0_bresp[1:0];
  assign axi_interconnect_0_M00_AXI_BUSER = m_axi_gmem0_buser[0];
  assign axi_interconnect_0_M00_AXI_BVALID = m_axi_gmem0_bvalid[0];
  assign axi_interconnect_0_M00_AXI_RDATA = m_axi_gmem0_rdata[63:0];
  assign axi_interconnect_0_M00_AXI_RID = m_axi_gmem0_rid[1:0];
  assign axi_interconnect_0_M00_AXI_RLAST = m_axi_gmem0_rlast[0];
  assign axi_interconnect_0_M00_AXI_RRESP = m_axi_gmem0_rresp[1:0];
  assign axi_interconnect_0_M00_AXI_RUSER = m_axi_gmem0_ruser[0];
  assign axi_interconnect_0_M00_AXI_RVALID = m_axi_gmem0_rvalid[0];
  assign axi_interconnect_0_M00_AXI_WREADY = m_axi_gmem0_wready[0];
  assign interrupt = krnl_helm_0_interrupt;
  assign m_axi_gmem0_araddr[63:0] = axi_interconnect_0_M00_AXI_ARADDR;
  assign m_axi_gmem0_arburst[1:0] = axi_interconnect_0_M00_AXI_ARBURST;
  assign m_axi_gmem0_arcache[3:0] = axi_interconnect_0_M00_AXI_ARCACHE;
  assign m_axi_gmem0_arid[1:0] = axi_interconnect_0_M00_AXI_ARID;
  assign m_axi_gmem0_arlen[7:0] = axi_interconnect_0_M00_AXI_ARLEN;
  assign m_axi_gmem0_arlock[0] = axi_interconnect_0_M00_AXI_ARLOCK;
  assign m_axi_gmem0_arprot[2:0] = axi_interconnect_0_M00_AXI_ARPROT;
  assign m_axi_gmem0_arqos[3:0] = axi_interconnect_0_M00_AXI_ARQOS;
  assign m_axi_gmem0_arregion[3:0] = axi_interconnect_0_M00_AXI_ARREGION;
  assign m_axi_gmem0_arsize[2:0] = axi_interconnect_0_M00_AXI_ARSIZE;
  assign m_axi_gmem0_aruser[0] = axi_interconnect_0_M00_AXI_ARUSER;
  assign m_axi_gmem0_arvalid[0] = axi_interconnect_0_M00_AXI_ARVALID;
  assign m_axi_gmem0_awaddr[63:0] = axi_interconnect_0_M00_AXI_AWADDR;
  assign m_axi_gmem0_awburst[1:0] = axi_interconnect_0_M00_AXI_AWBURST;
  assign m_axi_gmem0_awcache[3:0] = axi_interconnect_0_M00_AXI_AWCACHE;
  assign m_axi_gmem0_awid[1:0] = axi_interconnect_0_M00_AXI_AWID;
  assign m_axi_gmem0_awlen[7:0] = axi_interconnect_0_M00_AXI_AWLEN;
  assign m_axi_gmem0_awlock[0] = axi_interconnect_0_M00_AXI_AWLOCK;
  assign m_axi_gmem0_awprot[2:0] = axi_interconnect_0_M00_AXI_AWPROT;
  assign m_axi_gmem0_awqos[3:0] = axi_interconnect_0_M00_AXI_AWQOS;
  assign m_axi_gmem0_awregion[3:0] = axi_interconnect_0_M00_AXI_AWREGION;
  assign m_axi_gmem0_awsize[2:0] = axi_interconnect_0_M00_AXI_AWSIZE;
  assign m_axi_gmem0_awuser[0] = axi_interconnect_0_M00_AXI_AWUSER;
  assign m_axi_gmem0_awvalid[0] = axi_interconnect_0_M00_AXI_AWVALID;
  assign m_axi_gmem0_bready[0] = axi_interconnect_0_M00_AXI_BREADY;
  assign m_axi_gmem0_rready[0] = axi_interconnect_0_M00_AXI_RREADY;
  assign m_axi_gmem0_wdata[63:0] = axi_interconnect_0_M00_AXI_WDATA;
  assign m_axi_gmem0_wlast[0] = axi_interconnect_0_M00_AXI_WLAST;
  assign m_axi_gmem0_wstrb[7:0] = axi_interconnect_0_M00_AXI_WSTRB;
  assign m_axi_gmem0_wuser[0] = axi_interconnect_0_M00_AXI_WUSER;
  assign m_axi_gmem0_wvalid[0] = axi_interconnect_0_M00_AXI_WVALID;
  ...
  design_1_axi_interconnect_0_1 axi_interconnect_0
       (.ACLK(ap_clk_1),
        ...
        .S00_AXI_araddr(krnl_helm_0_m_axi_gmem0_ARADDR),
        .S00_AXI_arburst(krnl_helm_0_m_axi_gmem0_ARBURST),
        .S00_AXI_arcache(krnl_helm_0_m_axi_gmem0_ARCACHE),
        .S00_AXI_arlen(krnl_helm_0_m_axi_gmem0_ARLEN),
        .S00_AXI_arlock(krnl_helm_0_m_axi_gmem0_ARLOCK),
        .S00_AXI_arprot(krnl_helm_0_m_axi_gmem0_ARPROT),
        .S00_AXI_arqos(krnl_helm_0_m_axi_gmem0_ARQOS),
        .S00_AXI_arready(krnl_helm_0_m_axi_gmem0_ARREADY),
        .S00_AXI_arsize(krnl_helm_0_m_axi_gmem0_ARSIZE),
        .S00_AXI_arvalid(krnl_helm_0_m_axi_gmem0_ARVALID),
        .S00_AXI_awaddr(krnl_helm_0_m_axi_gmem0_AWADDR),
        .S00_AXI_awburst(krnl_helm_0_m_axi_gmem0_AWBURST),
        .S00_AXI_awcache(krnl_helm_0_m_axi_gmem0_AWCACHE),
        .S00_AXI_awlen(krnl_helm_0_m_axi_gmem0_AWLEN),
        .S00_AXI_awlock(krnl_helm_0_m_axi_gmem0_AWLOCK),
        .S00_AXI_awprot(krnl_helm_0_m_axi_gmem0_AWPROT),
        .S00_AXI_awqos(krnl_helm_0_m_axi_gmem0_AWQOS),
        .S00_AXI_awready(krnl_helm_0_m_axi_gmem0_AWREADY),
        .S00_AXI_awsize(krnl_helm_0_m_axi_gmem0_AWSIZE),
        .S00_AXI_awvalid(krnl_helm_0_m_axi_gmem0_AWVALID),
        .S00_AXI_bready(krnl_helm_0_m_axi_gmem0_BREADY),
        .S00_AXI_bresp(krnl_helm_0_m_axi_gmem0_BRESP),
        .S00_AXI_bvalid(krnl_helm_0_m_axi_gmem0_BVALID),
        .S00_AXI_rdata(krnl_helm_0_m_axi_gmem0_RDATA),
        .S00_AXI_rlast(krnl_helm_0_m_axi_gmem0_RLAST),
        .S00_AXI_rready(krnl_helm_0_m_axi_gmem0_RREADY),
        .S00_AXI_rresp(krnl_helm_0_m_axi_gmem0_RRESP),
        .S00_AXI_rvalid(krnl_helm_0_m_axi_gmem0_RVALID),
        .S00_AXI_wdata(krnl_helm_0_m_axi_gmem0_WDATA),
        .S00_AXI_wlast(krnl_helm_0_m_axi_gmem0_WLAST),
        .S00_AXI_wready(krnl_helm_0_m_axi_gmem0_WREADY),
        .S00_AXI_wstrb(krnl_helm_0_m_axi_gmem0_WSTRB),
        .S00_AXI_wvalid(krnl_helm_0_m_axi_gmem0_WVALID),
        .S01_ACLK(ap_clk_1),
        .S01_ARESETN(ap_rst_n_1),
        .S01_AXI_araddr(kernel_compute_profi_0_m_axi_common_ARADDR),
        .S01_AXI_arburst(kernel_compute_profi_0_m_axi_common_ARBURST),
        .S01_AXI_arcache(kernel_compute_profi_0_m_axi_common_ARCACHE),
        .S01_AXI_arid(kernel_compute_profi_0_m_axi_common_ARID),
        .S01_AXI_arlen(kernel_compute_profi_0_m_axi_common_ARLEN),
        .S01_AXI_arlock(kernel_compute_profi_0_m_axi_common_ARLOCK),
        .S01_AXI_arprot(kernel_compute_profi_0_m_axi_common_ARPROT),
        .S01_AXI_arqos(kernel_compute_profi_0_m_axi_common_ARQOS),
        .S01_AXI_arready(kernel_compute_profi_0_m_axi_common_ARREADY),
        .S01_AXI_arsize(kernel_compute_profi_0_m_axi_common_ARSIZE),
        .S01_AXI_aruser(kernel_compute_profi_0_m_axi_common_ARUSER),
        .S01_AXI_arvalid(kernel_compute_profi_0_m_axi_common_ARVALID),
        .S01_AXI_awaddr(kernel_compute_profi_0_m_axi_common_AWADDR),
        .S01_AXI_awburst(kernel_compute_profi_0_m_axi_common_AWBURST),
        .S01_AXI_awcache(kernel_compute_profi_0_m_axi_common_AWCACHE),
        .S01_AXI_awid(kernel_compute_profi_0_m_axi_common_AWID),
        .S01_AXI_awlen(kernel_compute_profi_0_m_axi_common_AWLEN),
        .S01_AXI_awlock(kernel_compute_profi_0_m_axi_common_AWLOCK),
        .S01_AXI_awprot(kernel_compute_profi_0_m_axi_common_AWPROT),
        .S01_AXI_awqos(kernel_compute_profi_0_m_axi_common_AWQOS),
        .S01_AXI_awready(kernel_compute_profi_0_m_axi_common_AWREADY),
        .S01_AXI_awsize(kernel_compute_profi_0_m_axi_common_AWSIZE),
        .S01_AXI_awuser(kernel_compute_profi_0_m_axi_common_AWUSER),
        .S01_AXI_awvalid(kernel_compute_profi_0_m_axi_common_AWVALID),
        .S01_AXI_bid(kernel_compute_profi_0_m_axi_common_BID),
        .S01_AXI_bready(kernel_compute_profi_0_m_axi_common_BREADY),
        .S01_AXI_bresp(kernel_compute_profi_0_m_axi_common_BRESP),
        .S01_AXI_buser(kernel_compute_profi_0_m_axi_common_BUSER),
        .S01_AXI_bvalid(kernel_compute_profi_0_m_axi_common_BVALID),
        .S01_AXI_rdata(kernel_compute_profi_0_m_axi_common_RDATA),
        .S01_AXI_rid(kernel_compute_profi_0_m_axi_common_RID),
        .S01_AXI_rlast(kernel_compute_profi_0_m_axi_common_RLAST),
        .S01_AXI_rready(kernel_compute_profi_0_m_axi_common_RREADY),
        .S01_AXI_rresp(kernel_compute_profi_0_m_axi_common_RRESP),
        .S01_AXI_ruser(kernel_compute_profi_0_m_axi_common_RUSER),
        .S01_AXI_rvalid(kernel_compute_profi_0_m_axi_common_RVALID),
        .S01_AXI_wdata(kernel_compute_profi_0_m_axi_common_WDATA),
        .S01_AXI_wlast(kernel_compute_profi_0_m_axi_common_WLAST),
        .S01_AXI_wready(kernel_compute_profi_0_m_axi_common_WREADY),
        .S01_AXI_wstrb(kernel_compute_profi_0_m_axi_common_WSTRB),
        .S01_AXI_wuser(kernel_compute_profi_0_m_axi_common_WUSER),
        .S01_AXI_wvalid(kernel_compute_profi_0_m_axi_common_WVALID));
  design_1_kernel_compute_profi_0_0 kernel_compute_profi_0
       (.clock(ap_clk_1),
        .departure({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,krnl_helm_0_departure_kernel}),
        .done_port(kernel_compute_profi_0_done_port),
        .durations({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,krnl_helm_0_durations_kernel}),
        .m_axi_common_ARADDR(kernel_compute_profi_0_m_axi_common_ARADDR),
        .m_axi_common_ARBURST(kernel_compute_profi_0_m_axi_common_ARBURST),
        .m_axi_common_ARCACHE(kernel_compute_profi_0_m_axi_common_ARCACHE),
        .m_axi_common_ARID(kernel_compute_profi_0_m_axi_common_ARID),
        .m_axi_common_ARLEN(kernel_compute_profi_0_m_axi_common_ARLEN),
        .m_axi_common_ARLOCK(kernel_compute_profi_0_m_axi_common_ARLOCK),
        .m_axi_common_ARPROT(kernel_compute_profi_0_m_axi_common_ARPROT),
        .m_axi_common_ARQOS(kernel_compute_profi_0_m_axi_common_ARQOS),
        .m_axi_common_ARREADY(kernel_compute_profi_0_m_axi_common_ARREADY),
        .m_axi_common_ARSIZE(kernel_compute_profi_0_m_axi_common_ARSIZE),
        .m_axi_common_ARUSER(kernel_compute_profi_0_m_axi_common_ARUSER),
        .m_axi_common_ARVALID(kernel_compute_profi_0_m_axi_common_ARVALID),
        .m_axi_common_AWADDR(kernel_compute_profi_0_m_axi_common_AWADDR),
        .m_axi_common_AWBURST(kernel_compute_profi_0_m_axi_common_AWBURST),
        .m_axi_common_AWCACHE(kernel_compute_profi_0_m_axi_common_AWCACHE),
        .m_axi_common_AWID(kernel_compute_profi_0_m_axi_common_AWID),
        .m_axi_common_AWLEN(kernel_compute_profi_0_m_axi_common_AWLEN),
        .m_axi_common_AWLOCK(kernel_compute_profi_0_m_axi_common_AWLOCK),
        .m_axi_common_AWPROT(kernel_compute_profi_0_m_axi_common_AWPROT),
        .m_axi_common_AWQOS(kernel_compute_profi_0_m_axi_common_AWQOS),
        .m_axi_common_AWREADY(kernel_compute_profi_0_m_axi_common_AWREADY),
        .m_axi_common_AWSIZE(kernel_compute_profi_0_m_axi_common_AWSIZE),
        .m_axi_common_AWUSER(kernel_compute_profi_0_m_axi_common_AWUSER),
        .m_axi_common_AWVALID(kernel_compute_profi_0_m_axi_common_AWVALID),
        .m_axi_common_BID(kernel_compute_profi_0_m_axi_common_BID[0]),
        .m_axi_common_BREADY(kernel_compute_profi_0_m_axi_common_BREADY),
        .m_axi_common_BRESP(kernel_compute_profi_0_m_axi_common_BRESP),
        .m_axi_common_BUSER(kernel_compute_profi_0_m_axi_common_BUSER),
        .m_axi_common_BVALID(kernel_compute_profi_0_m_axi_common_BVALID),
        .m_axi_common_RDATA(kernel_compute_profi_0_m_axi_common_RDATA),
        .m_axi_common_RID(kernel_compute_profi_0_m_axi_common_RID[0]),
        .m_axi_common_RLAST(kernel_compute_profi_0_m_axi_common_RLAST),
        .m_axi_common_RREADY(kernel_compute_profi_0_m_axi_common_RREADY),
        .m_axi_common_RRESP(kernel_compute_profi_0_m_axi_common_RRESP),
        .m_axi_common_RUSER(kernel_compute_profi_0_m_axi_common_RUSER),
        .m_axi_common_RVALID(kernel_compute_profi_0_m_axi_common_RVALID),
        .m_axi_common_WDATA(kernel_compute_profi_0_m_axi_common_WDATA),
        .m_axi_common_WLAST(kernel_compute_profi_0_m_axi_common_WLAST),
        .m_axi_common_WREADY(kernel_compute_profi_0_m_axi_common_WREADY),
        .m_axi_common_WSTRB(kernel_compute_profi_0_m_axi_common_WSTRB),
        .m_axi_common_WUSER(kernel_compute_profi_0_m_axi_common_WUSER),
        .m_axi_common_WVALID(kernel_compute_profi_0_m_axi_common_WVALID),
        .position({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,krnl_helm_0_position_kernel}),
        .reset(ap_rst_n_1),
        .route({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,krnl_helm_0_route_kernel}),
        .seed({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,krnl_helm_0_seed_kernel}),
        .start_port(krnl_helm_0_durations_kernel_ap_vld));
  design_1_krnl_helm_0_0 krnl_helm_0
       (.ap_clk(ap_clk_1),
        .ap_rst_n(ap_rst_n_1),
        .departure_kernel(krnl_helm_0_departure_kernel),
        .durations_kernel(krnl_helm_0_durations_kernel),
        .durations_kernel_ap_ack(kernel_compute_profi_0_done_port),
        .durations_kernel_ap_vld(krnl_helm_0_durations_kernel_ap_vld),
        .interrupt(krnl_helm_0_interrupt),
        .m_axi_gmem0_ARADDR(krnl_helm_0_m_axi_gmem0_ARADDR),
        .m_axi_gmem0_ARBURST(krnl_helm_0_m_axi_gmem0_ARBURST),
        .m_axi_gmem0_ARCACHE(krnl_helm_0_m_axi_gmem0_ARCACHE),
        .m_axi_gmem0_ARLEN(krnl_helm_0_m_axi_gmem0_ARLEN),
        .m_axi_gmem0_ARLOCK(krnl_helm_0_m_axi_gmem0_ARLOCK),
        .m_axi_gmem0_ARPROT(krnl_helm_0_m_axi_gmem0_ARPROT),
        .m_axi_gmem0_ARQOS(krnl_helm_0_m_axi_gmem0_ARQOS),
        .m_axi_gmem0_ARREADY(krnl_helm_0_m_axi_gmem0_ARREADY),
        .m_axi_gmem0_ARSIZE(krnl_helm_0_m_axi_gmem0_ARSIZE),
        .m_axi_gmem0_ARVALID(krnl_helm_0_m_axi_gmem0_ARVALID),
        .m_axi_gmem0_AWADDR(krnl_helm_0_m_axi_gmem0_AWADDR),
        .m_axi_gmem0_AWBURST(krnl_helm_0_m_axi_gmem0_AWBURST),
        .m_axi_gmem0_AWCACHE(krnl_helm_0_m_axi_gmem0_AWCACHE),
        .m_axi_gmem0_AWLEN(krnl_helm_0_m_axi_gmem0_AWLEN),
        .m_axi_gmem0_AWLOCK(krnl_helm_0_m_axi_gmem0_AWLOCK),
        .m_axi_gmem0_AWPROT(krnl_helm_0_m_axi_gmem0_AWPROT),
        .m_axi_gmem0_AWQOS(krnl_helm_0_m_axi_gmem0_AWQOS),
        .m_axi_gmem0_AWREADY(krnl_helm_0_m_axi_gmem0_AWREADY),
        .m_axi_gmem0_AWSIZE(krnl_helm_0_m_axi_gmem0_AWSIZE),
        .m_axi_gmem0_AWVALID(krnl_helm_0_m_axi_gmem0_AWVALID),
        .m_axi_gmem0_BREADY(krnl_helm_0_m_axi_gmem0_BREADY),
        .m_axi_gmem0_BRESP(krnl_helm_0_m_axi_gmem0_BRESP),
        .m_axi_gmem0_BVALID(krnl_helm_0_m_axi_gmem0_BVALID),
        .m_axi_gmem0_RDATA(krnl_helm_0_m_axi_gmem0_RDATA),
        .m_axi_gmem0_RLAST(krnl_helm_0_m_axi_gmem0_RLAST),
        .m_axi_gmem0_RREADY(krnl_helm_0_m_axi_gmem0_RREADY),
        .m_axi_gmem0_RRESP(krnl_helm_0_m_axi_gmem0_RRESP),
        .m_axi_gmem0_RVALID(krnl_helm_0_m_axi_gmem0_RVALID),
        .m_axi_gmem0_WDATA(krnl_helm_0_m_axi_gmem0_WDATA),
        .m_axi_gmem0_WLAST(krnl_helm_0_m_axi_gmem0_WLAST),
        .m_axi_gmem0_WREADY(krnl_helm_0_m_axi_gmem0_WREADY),
        .m_axi_gmem0_WSTRB(krnl_helm_0_m_axi_gmem0_WSTRB),
        .m_axi_gmem0_WVALID(krnl_helm_0_m_axi_gmem0_WVALID),
        .position_kernel(krnl_helm_0_position_kernel),
        .route_kernel(krnl_helm_0_route_kernel),
        ...
        .seed_kernel(krnl_helm_0_seed_kernel));
endmodule
